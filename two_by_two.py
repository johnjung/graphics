...
if __name__=="__main__":
  ...
  if arguments['--xmin'] == None:
    arguments['--xmin'] = min([float(r[arguments['--x']]) for r in records])
  if arguments['--xmax'] == None:
    arguments['--xmax'] = max([float(r[arguments['--x']]) for r in records])
  if arguments['--ymin'] == None:
    arguments['--ymin'] = min([float(r[arguments['--y']]) for r in records])
  if arguments['--ymax'] == None:
    arguments['--ymax'] = max([float(r[arguments['--y']]) for r in records])
